...
export default function Countdown() {
  ...
  return (
    <section className="countdown-section relative mt-0 px-4 py-[60px] section-mesh" style={{ marginTop: 0, transform: 'none', background: 'var(--color-surface)' }}>
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
        className="countdown-card max-w-5xl mx-auto bg-white rounded-2xl p-6 md:p-10 border border-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.08)] relative z-10"
